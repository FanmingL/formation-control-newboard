...
static Point_t point1={400,1800},point2={2400,1800},point3=point1;//,point4={2200,500},point5=point1;
...
void change_target2(void)
{
	...
	if (point_count > 0 && point_count < point_num) div = calc_dist2();
...
Target_t trajectory_generate2(float interval, float coordinate_x, float coordinate_y, float yaw, Pos_t &stable_pos_)
{
	if (startflag) init2();
    target.x2 = target.x1;
    target.y2 = target.y1;
    
	Calc_Pos2(interval, coordinate_x, coordinate_y, yaw);
